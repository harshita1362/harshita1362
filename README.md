...
**Deep Learning:**  
CNN • DNN • MLP • Autoencoders • Transformers • Vision Transformers
...
Power BI • Pandas • NumPy • Google Colab • SQL
...
A Python/Tkinter utility designed to generate unprotected copies of
protected Excel workbooks while handling different worksheet/workbook
...
Computer Vision project for detecting and counting available parking
spaces using OpenCV.
